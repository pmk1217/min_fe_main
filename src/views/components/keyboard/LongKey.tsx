...
const LongKey = ({ label, width = 250 }: KeyCapProps) => {
  ...
  return (
    ...
    >
      ...
      <svg width={width} height={height} style={{ position: 'absolute', top: 0, left: 0, zIndex: 1 }}>
        {/* ↘ */}
        <line x1={centerX - innerWidth / 2.1} y1={centerY - innerHeight / 2.2} x2={2} y2={2} stroke="#888" strokeWidth={2} />
        {/* ↙ */}
        <line x1={centerX + innerWidth / 2.4} y1={centerY - innerHeight / 2.6} x2={width - 2} y2={2} stroke="#888" strokeWidth={2} />
        {/* ↖ */}
        <line
          x1={centerX + innerWidth / 2.1}
        ...
        />
        {/* ↗ */}
        <line x1={centerX - innerWidth / 2.1} y1={centerY + innerHeight / 2.6} x2={2} y2={height - 2} stroke="#888" strokeWidth={2} />
      </svg>
